...
<div id="box"  class="newBankCardBox bankcardmanage">
	...
	<form action="/pay/lakala/producer.htm" method="post" data-form id="jform">
		...
		<div class="group group-justify">
			...
			<div class="group-item">
				<a href="javascript:toPay('${bankCard.id }');" class="group-rowspan">
					<span class="group-colspan">
						<em>${bankCard.bankName }</em><br/>
	...
	<div class="button">
		<a href='/pay/lakala/addBankCard.htm?type=1&orderNos=${orderNos }' class="btn btn-default btn-block btn-danger">
