...
<div class="login" id="j-login" style="display:none;width:100%">
	<form method="post" action="${ctx }/wap/${sessionShopNo}/buy/bankcard/add${ext}" id="paymentcode-form" class="form-login">
  		<input type="hidden" name="retUrl" value='/pay/switchBankCardForRecharge.htm?rechargeNo=${rechargeNo}'>
  		<input type="hidden" name="errorUrl" value='/pay/bankCardRecharge.htm?rechargeNo=${rechargeNo}'>
...
<form id=j-form action="${ctx }/pay/switchBankCardForRecharge${ext}" method="get">
