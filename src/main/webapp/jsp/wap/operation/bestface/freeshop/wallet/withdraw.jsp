...
<div id="box">
	<div id="step1">
		<form action="" method="post" id="jform" data-form>
			...
			<div class="button">
				<button type="button" class="btn btn-danger btn-block disabled" data-submit id="jsubmit" onclick="buttonClick()">下一步</button>
			</div>
		</form>
		<!-- 确定转出 -->
	...
	<div id="step2">
		...
		<div class="button">
			<a href="${ctx }/free/wallet/withdraw/add${ext}" 
...
$('#jsubmit').click(function(){
	...
	if(bool){
		$.post("${ctx }/free/wallet/testMobilecode${ext}", 
...
//获取验证码
function getCode(el){
	$.post("${ctx }/free/wallet/phoneCode${ext}",
