...
<div id="box">
	 ...
	 <form action="/free/mine/phone/doCheck.htm"  method="post" id="j-form" data-form>
...
//获取验证码
function getCode(el){
	$.post("${ctx}/wap/${freeShopNo}/buy/mobilecode/phoneCode${ext}",
			{"type" : 5}, function(falg){
		if("true" != falg){
...
function formSubmit() {
	if (validForm.form()) {
		$.post("/wap/${freeShopNo}/buy/mobilecode/testMobilecode.htm", {"type" : 5, "mobilecode" : $('#code').val()},
				function(jsonData) {
