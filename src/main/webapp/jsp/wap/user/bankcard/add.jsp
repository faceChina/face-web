...
<body>
	<div id="box">
		<form action="${ctx }/wap/${sessionShopNo}/buy/bankcard/toadd${ext}"
			...
			<input type="hidden" name="rechargeNo" id="rechargeNo" value='${rechargeNo }'>
			...
			<div id="second-step" style="display: none">
				...
				<div class="button">
					<button id="second-button" type="button" onclick="addBankCard(this)"
	...
	<script type="text/javascript">
		...
		function cardbin(thiz) {
			...
			if (null == bankCard || "" == bankCard)
				return;
			$.post("${ctx}/wap/${sessionShopNo}/buy/bankcard/cardbin${ext}", {
				"bankCard" : bankCard
			}, function(jsonData) {
