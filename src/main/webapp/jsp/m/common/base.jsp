...
<link rel="stylesheet" type="text/css" href="${resourcePath}css/main-spadm.css">
<link rel="stylesheet" type="text/css" href="${resourcePath}css/main-gw.css">
<link rel="stylesheet" type="text/css" href="${resourcePath}css/main-lp.css">
...
<%-- <script type="text/javascript" src="${resourceBasePath}js/underscore.js"></script> --%>
