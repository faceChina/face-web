...
<ul class="sidebar" id="j-toggleCont">
	<li><a href="javascript:void(0)"> <span class="arrow"></span> 帐户中心</a>
		<ul>
			<li  tabindex="basics"><a href="${ctx }/u/account/shopAccount${ext}">基本资料</a></li>
			<li  tabindex="purse"><a href="${ctx}/u/account/shopInout${ext}"> 店铺收支</a></li>
		</ul>
	</li>
	<li><a href="javascript:void(0)"> <span class="arrow"></span> 官网装修</a>
		<ul>
			<li  tabindex="template"><a href="${ctx}/u/template/WGW/listOwTemplate${ext}">官网模板管理</a></li>
			<c:if test="${owTemplateHp.isModular == 1 }">
			<li  tabindex="modular"><a href="${ctx}/u/template/WGW/listModular${ext}">首页模块设定</a></li>
			</c:if>
			<c:if test="${owTemplateHp.isCarlOrBg != 0 }">
				<li  tabindex="carousel"><a href="${ctx}/u/template/WGW/carousel${ext}">官网轮播图管理</a></li>
			</c:if>
		</ul>
	</li>
	<li><a href="javascript:void(0)"> <span class="arrow"></span> 素材管理</a>
		<ul>
			<li  tabindex="article"><a href="${ctx}/u/stuff/article/listArticle${ext}">文章管理</a></li>
			<li  tabindex="photo"><a href="${ctx}/u/stuff/album/listAlbum${ext}">相册管理</a></li>
		</ul>
	</li>
	
	<li><a href="javascript:void(0)"> <span class="arrow"></span> 商城装修</a>
		<ul>
			<li  tabindex="template-sc"><a href="${ctx}/u/template/GW_WSC/listOwTemplate${ext}">模板管理</a></li>
			<c:if test="${owTemplateScHp.isModular == 1 }">
			<li  tabindex="modular-sc"><a href="${ctx}/u/template/GW_WSC/listModular${ext}">首页模块设定 </a></li>
			</c:if>
			<c:if test="${owTemplateScHp.isCarlOrBg != 0 }">
			<li  tabindex="carousel-sc"><a href="${ctx}/u/template/GW_WSC/carousel${ext}">商城轮播图管理</a></li>
			</c:if>
			<c:if test="${owTemplateScHp.code == 'HP_GW_WSC_V31_6' }">
				<li tabindex="signPic-sc"><a href="${ctx}/u/shop/signPic${ext}">店铺招牌模板管理</a></li>
			</c:if>
		</ul>
	</li>
	...
	<li><a href="javascript:void(0)"><span class="arrow"></span> 订单管理<i class="color-danger" id="gw-total-count"></i></a>
     ...
     <li><a href="javascript:void(0)"><span class="arrow"></span> 分公司管理</a>
		<ul>
			<li  tabindex="subbranch"><a href="${ctx}/u/subbranch/list${ext}">分公司列表</a></li>
		</ul>
	</li>
