										...
										<div class="appmsg  editing">
											<div id="js_appmsg_preview" class="appmsg_content">
												...
												<div class="appmsg_thumb_wrp">
													<img id="showImg"  class="js_appmsg_thumb appmsg_thumb" src="">
													<i class="appmsg_thumb default">封面图片</i>
												</div>
												<p class="appmsg_description"></p>
											</div>
											</div>
										</div>
									</div>
										...
										<div class="inner">
											...
											<div class="js_desc_area appmsg_edit_item">
												<label for="" class="frm_label">摘要</label>
													<span class="frm_textarea_box"><textarea id="description" class="frm_textarea j-datawx" onkeyup="wechat.blurText(this)" name="description"></textarea></span>
											</div>
											<div class="appmsg_edit_item">
