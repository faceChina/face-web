						...
						<div class="box">
							<div class="title">
								<ul class="nav nav-tabs">
									<li class="active"><a href="#members-set" data-toggle="tab">添加文章</a></li>
								</ul>
							</div>
							<div class="content">
								<form class="form-horizontal" id="j-form" action="${ctx}/u/stuff/article/addArticle${ext}" method="post">
									...
									<div class="form-group">
										...
										<div class="col-md-3">
											...
											<input type="hidden" id="picturePath" name="picPath" value="${news.picPath}"/>
									...
									<div class="text-center">
										<button type="button" class="btn btn-default" id="submitArticle">发布</button>
										<button type="button" class="btn btn-default" onclick="canel()">取消</button>
									</div>
								</form>
							</div>
						</div>
