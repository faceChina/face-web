...
<script type="text/javascript">
	 ...
	 */
	function getJson() {
		var owTemplateCode = '${owTemplateHp.code}';
		var arr = new Array();
		var i =0;
...
<body>
	...
	<div class="container" id="j-content">
		<div class="row">
			...
			<div class="col-md-10">
					<div class="row">
						<c:set var="crumbs" value="gwcarousel"/>
						...
						<div class="box">
							...
							<div class="content">
								<div class="alert alert-warning" role="alert" >
									<p>提示：</p>
									<p>1.轮播图图片规格大小为${owTemplateHp.carouselImageWidth }*${owTemplateHp.carouselImageHeight }px。</p>
									<p>2.本类目下您最多可以上传 5 张图片。</p>
									<p>3.本地上传图片大小不能超过2MB。</p>
								</div>
								<c:if test="${owTemplateHp.isCarlOrBg == 2 }">
									<ul class="add-uploadpic j-addpic" data-height="232">
										<c:forEach items="${carouselDiagramList }" var="data" varStatus="status">
									  		<li class="" >
									  			...
									  			<input type="hidden" name="list[${status.index }].owTemplateId" value="${owTemplateHp.id }"/>
			 					...
			 					<c:if test="${owTemplateHp.isCarlOrBg == 1 }">
