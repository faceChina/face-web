...
<%-- 						<%@include file="../../common/crumbs.jsp"%> --%>
							...
							<div class="content">
								<form method="post" id="j-activity">
									<div class="form-horizontal">
										...
										<c:if test="${owTemplateScHp.isNameEn == 1 && modularType == 1}">
										...
										<c:if test="${owTemplateScHp.isImage == 1 || modularType == 2}"> 
											<div class="form-group">
												...
												<div class="col-md-6" style="margin-left:20px;">
													...
													<div class="btn btn-default btn-upload j-tooltip">
														上传图片
														<input type="button" name="standardUploadImg" value="" class="form-control"  data-toggle="tooltip" data-original-title="请上传尺寸大小为 ${owTemplateScHp.modularImageWidth }*${owTemplateScHp.modularImageHeight } 像素的图片，以png格式为准。"/>
													</div>
												</div>
											</div>
										</c:if>
										<c:if test="${modularType == 1 }">
											<div class="form-group">
										...
										<c:if test="${owTemplateScHp.isBackgroundColor == 1 && modularType == 1}">
											<div class="form-group">
												<label class="col-md-2 control-label">背景颜色：</label>
												<div class="col-md-10">
													 <p><input type="text" name="backgroundColor" value="${modular.backgroundColor }" class="color  form-control input-short-3" id="myBgColor" onchange="
	...
	<%--@include file="addlink-gw-wsc.jsp" --%>
	<!-- footer -->
