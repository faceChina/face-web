				...
				<div class="row">
					<div class="box">
						...
						<c:if test="${empty shopType.id}">
							<form action="${ctx}/u/good/shopType/add${ext}" method="post" id="j-activity"  method="post" enctype="multipart/form-data" autocomplete="off">
						</c:if>
						<c:if test="${not empty shopType.id}">
							<form action="${ctx}/u/good/shopType/edit/${shopType.id}${ext}" method="post" id="j-activity" enctype="multipart/form-data" autocomplete="off">
						</c:if>
								...
								<div class="form-horizontal">
									...
									<div class="form-group">
										...
										<div class="col-md-6" style="margin-left: 20px;">
											...
											<div><span style="color: #666666;">请上传尺寸大小为 ${owTemplateGt.goodTypeImageWidth}*${owTemplateGt.goodTypeImageHeight} 像素的图片，以png格式为准。</span></div>
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-10">
											<c:if test="${empty shopType.fontColor}">
											<input class="color form-control input-short-3"
												name="fontColor" value="#333333" id="myColor" />
											</c:if>
											<c:if test="${not empty shopType.fontColor}">
											<input class="color form-control input-short-3"
												name="fontColor" value="${shopType.fontColor}" id="myColor" />
											</c:if>
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-10 col-md-offset-2">
											...
											<a href="javascript:history.go(-1);" class="btn btn-default">取消返回</a>
										</div>
									</div>
								</div>
