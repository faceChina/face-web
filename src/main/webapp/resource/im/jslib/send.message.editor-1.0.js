...
var sendMessageEditor = {
    ...
    init: function (userJID) {
        ...
        var html = [
            '<html>', 
            '<head><style type="text/css">body{border:0;margin:0;padding:0px;height:98%;cursor:text;background-color:white;font-size:12px;font-family:Courier,serif,monospace; word-wrap:break-word;}</style></head>',
