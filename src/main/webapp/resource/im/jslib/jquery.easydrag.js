/*
Gildas P. / www.gildasp.fr / Le 06/01/2014
			...
			handle.mousedown(function(event){
				...
				$(document).on('mousemove', function(e){
					...
					eventY = e.pageY;
					 ...
					 //不让窗口移出去
					 var windWidth = $(this).width()-dragItem.width();
					 var windHeight = $(this).height()-dragItem.height();
					 if((initItemX + eventX-initEventX)>0){
						 nextX = (initItemX + eventX-initEventX)> windWidth?windWidth:(initItemX + eventX-initEventX);
					 }
					 if((initItemY + eventY-initEventY)>0){
						 nextY = (initItemY + eventY-initEventY)> windHeight?windHeight:(initItemY + eventY-initEventY);
					 }
