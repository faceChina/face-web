...
/**
 * 平台收取手续费+信用卡手续费
* @ClassName: PlatformAndCreditCardScene 
* @Description: TODO(这里用一句话描述这个类的作用) 
* @author phb 
* @date 2015年3月20日 下午2:11:31 
*
 */
public class PlatformAndCreditCardScene implements FeeScene {
	...
	public FeeDto calculation(Long amount) throws PaymentException {
		try {
			...
			AssertUtil.notNull(lianlian, "未配置LIANLIAN_CREDIT_FEE");
