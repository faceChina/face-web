 ...
 */
public class MappingJackson3HttpMessageConverter extends AbstractHttpMessageConverter<Object>
	 ...
	 */
	public MappingJackson3HttpMessageConverter() {
	...
	private Object readJavaType(JavaType javaType, HttpInputMessage inputMessage) {
		try {
			...
			String s = ConvertUtil.getBodyString(in2);
			return ConvertUtil.formatJson(s);
		}
		catch (IOException ex) {
			throw new HttpMessageNotReadableException("Could not read JSON: " + ex.getMessage(), ex);
		}catch (Exception ex) {
			throw new HttpMessageNotReadableException(" JSON Converter Failure: " + ex.getMessage(), ex);
		}
	}
